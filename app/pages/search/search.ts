...
// Ignore complains by TS here and hope that typings will soon be available for Lodash
import * as lodash from 'lodash';
import * as ProgressIndicator from '../../../plugins/org.pbernasconi.progressindicator/www/progressIndicator';

@Page({
  templateUrl: 'build/pages/search/search.html',
  // viewProviders appear to have changed to `providers`. Thanks TypeScript for pointing it out :)
  providers: [],
